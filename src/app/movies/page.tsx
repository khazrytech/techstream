  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 pb-28 space-y-6">
      <div className="flex items-center space-x-3 pt-2">
        ...
        <h1 className="text-lg font-black tracking-wider text-white">MOVIES</h1>
      </div>
      ...
      {movies.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 space-y-3 text-center">
          ...
          <p className="text-xs text-zinc-400 font-bold">Hakuna sinema zilizopatikana kwa sasa.</p>
          <p className="text-[10px] text-zinc-600">Sinema mpya zikiongezwa kwenye mfumo zitaonekana hapa.</p>
        </div>
      ) : null}
    </div>
  );

...
import { Tv, Mail, Lock, User, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-3xl p-8 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-zinc-400">Tengeneza Akaunti Mpya Bure</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-1">
            <label className="text-[11px] font-bold text-zinc-400 uppercase tracking-wider">Jina Kamili</label>
          ...
          >
            {loading ? "Inatengeneza..." : "KILAMILISHA USAJILI"}
